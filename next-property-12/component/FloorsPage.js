...
const Floors = ({ apartment }) => {
  ...
  useEffect(() => {
    console.log("Floors::useEffect::re-rendered");
    setCurProperties(fullProperties[apartment]);
  }, [fullProperties[apartment]]);
      ...
      curProperties[i].map((room) => {
        ...
        result1.push(
          <>
            ...
            {/* <Room uid={room.uid} key={j} /> */}
            <Room room={room} key={j} />
            ...
            {/* >*/}
            {/*   {/1* 호수 *1/}*/}
            {/*   {/1* bgColor="gray.600" *1/}*/}
            {/*   {/1* bgGradient={ *1/}*/}
            {/*   {/1*   room.has_issue > 0 *1/}*/}
            {/*   {/1*     ? "linear-gradient(to right, rgba(155,155,0,0.5) 5%, rgba(111,111,111,0.8) 70%)" *1/}*/}
            {/*   {/1*     : "0" *1/}*/}
            {/*   {/1* } *1/}*/}
            {/*   {/1* bgColor={room.has_issue > 0 ? "yellow.500" : "gray.600"} *1/}*/}
            {/*   {/1* borderColor="gray.500" *1/}*/}
            {/*   <Flex*/}
            {/*     ml="-1.0em"*/}
            {/*     borderWidth={1}*/}
            ...
            {/*     position="relative"*/}
            {/*   >*/}
            {/*     {/1* 월세납입일과 보증금을 표시합니다 *1/}*/}
            {/*     {/1* bgColor="gray.500" *1/}*/}
            {/*     <Flex*/}
            {/*       bgColor={*/}
            {/*         room.occupant_id <= 0*/}
            {/*           ? "gray.600"*/}
            ...
            {/*         </Text>*/}
            {/*       </Flex>*/}
            {/*       {/1* <Text fontSize="xl">{room.room_no}</Text> *1/}*/}
            {/*       {/1* <Text fontSize="xl">{room.payday}</Text> *1/}*/}
            {/*       {/1* <Text fontSize="xl">{curProperties[i].length}</Text> *1/}*/}
            {/*     </Flex>*/}
            {/*     {/1* 납입일입니다 *1/}*/}
            {/*     <Flex*/}
            {/*       w={["3.5em"]}*/}
            ...
            {/*     spacing={1.5}*/}
            {/*   >*/}
            {/*     {/1* 공실일 경우 투명도를 0으로 설정합니다 *1/}*/}
            {/*     {/1* 반려동물 유무 *1/}*/}
            {/*     {/1* bgColor="green.600" *1/}*/}
            {/*     {/1* bgColor="gray.600" *1/}*/}
            {/*     <Flex*/}
            {/*       rounded="md"*/}
            {/*       w={["1.5em"]}*/}
            ...
            {/*       {/1* <IoIosPaw /> *1/}*/}
            {/*       {/1* <FaCar /> *1/}*/}
            {/*       {/1* <Icon color="gray.700" as={IoIosPaw} boxSize="1.3rem" /> *1/}*/}
            {/*       <Icon color="green.600" as={IoIosPaw} boxSize="1.3rem" />*/}
            {/*     </Flex>*/}
            {/*     {/1* 차량 유무 *1/}*/}
            {/*     {/1* bgColor="blue.700" *1/}*/}
            {/*     <Flex*/}
            {/*       justifyContent="center"*/}
