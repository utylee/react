...
const PagePrint = () => {
  ...
  useEffect(() => {
    ...
    console.log("PagePrint::useEffect::[pageCur] is::");
    console.log(pageCur);
    if (typeof window != "undefined" && window.document) {
      ...
      if (pageCur == "PagePrint") {
        ...
        console.log("PagePrint::useEffect::changed bg to white");
		  
        // 출력을 여기서 명령을 내리니 함수 중간에 실행하고 다음 실행하고
        // 다음 실행코드로 넘어가서 그런지 자꾸 모바일상에서 창이 닫히는 문제가
        // 발생하였습니다. 따라서 index.js의 useEffect상에서 printCur가 변할 때
        // 판단해서 window.print()를 해주었습니다
        // window.print();
        // setTimeout(() => window.print(), 1000);
        setTimeout(async () => backToIndex(), 5000);
      }
    }
